...
\begin{definition}
  ...
  (1) A \emph{global sample\/} is a maximally consistent set of formulas of the form $\sbar\phi(x^{\rm s}\,;b)\approx_\epsilon\mu$, where $b\in\U^{|z|}$, $\epsilon,\mu\in\RR$, and $\phi(x\,;z)\in L$.

  (1) A \emph{global sample\/} is a maximally consistent set of formulas of the form $\sbar\phi(x^{\rm s})\approx_\epsilon\mu$, where $\phi(x)\in L(\U)$, and $\epsilon,\mu\in\RR$.
  
  (2) A \emph{global sample\/} is a global type $p(x^{\rm s})\in S(\U)$.
  
  (3) A \emph{global sample\/} is a global type $p(x^{\rm s})\in S(\U,\RR))$.
  
  (4) A \emph{global sample\/} is a global type $p(x^{\rm s})\in S(\U^{\rm f})$.
  
  (5) A \emph{global sample\/} is a global type $p(x^{\rm s})\in S(\U^{\rm f*})$.\QED
\end{definition}

\begin{notation}
  For any global type $p(x)\in S(\U)$ and formula $\phi(x\,;z)\in L$ we write 
  ...
  %
  A global type may be identified with a family of externally definable sets.
  ...
  %
  A global sample my be identified with a family of externally definable functions.
  \QED
\end{notation}
...
\begin{proof}
  Let $s\in\U^{\rm f*}$ be such that $\sbar\phi(s\,;b)\approx\sbar\phi(p\,;b)$ for all $b\in\U^{|z|}$.
  %
  ...
  $\{b:\sbar\phi(s\,;b)<\epsilon\}$, hence is definable in $\U^{\rm f*}$.
  %
