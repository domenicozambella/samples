...
\begin{proof}
  ...
  %
  Clearly, some element of $\supp(r)$ proves $\ssf{3}$.
\end{proof}
...
\begin{lemma}
  ...
  \begin{itemize}
    \item[1.] $s$ is smooth;
    \item[2.] for every $b\in\U^{|z|}$ there is a finite sample $r\in M^{\rm f}$ such that $\sbar\phi(s\,;b)\approx_\epsilon\sbar\phi(r\,;b)$. (The sample $r$ depends on $M$, $\epsilon$ and $b$.)
    \item[3.] there are some finite samples $r_1,\dots,r_n\in M^{\rm f}$ such that for every $b\in\U^{|z|}$ we have $\sbar\phi(s\,;b)\approx_\epsilon\sbar\phi(r_i\,;b)$ for some $s_i$. (The samples $r_1,\dots,r_n$ as well as the number $n$ depend on $\epsilon$ and $M$.)
  \end{itemize}
\end{lemma}
...
\begin{proof}
  ...
  All the other implications are evident.
\end{proof}
...
\begin{definition}\label{def_approximable_sample}
  ...
  %
  We say that $s$ is \emph{approximable\/} on $\B$ if for every $\epsilon$ there is a finite sample $r\in M^{\rm f}$ such that $\sbar\phi(s,b)\approx_\epsilon\sbar\phi(r,b)$ for every $b\in\B$. (The sample $r$ depends on $\epsilon$ and $M$.) We add \emph{for $\phi(x\,;z)$ over $M$\/} when these are not clear from the context.\QED
\end{definition}
